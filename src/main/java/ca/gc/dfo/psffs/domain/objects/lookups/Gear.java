...
public class Gear extends BaseLookup
{
    @Id
    @GeneratedValue(generator = "gearSeqGenerator", strategy = GenerationType.SEQUENCE)
    @SequenceGenerator(name = "gearSeqGenerator", sequenceName = "CTAB_GEAR_ID_SEQ", allocationSize = 1, initialValue = 1000)
    @Column(name = "id")
    private Integer id;
}
