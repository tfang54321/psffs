 ...
 * 
 */
package ca.gc.dfo.psffs.utility;
...
public class GeneratePdfReport {
	...
	public  static ByteArrayInputStream allUsersAuditReport(java.util.List<CommonAuditDto> auditReportDate, MessageSource messageSource, Locale locale) {
...
//					cells[4].setPaddingLeft(2);
	...
	public  static ByteArrayInputStream userAuditReport(String userID, java.util.List<CommonAuditDto> auditReportDate, MessageSource messageSource, Locale locale) {
